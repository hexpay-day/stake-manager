...
[div align="center"](https://coveralls.io/github/hexpay-day/stake-manager?branch=master)
...
*   [https://dune.com/hexpay\_day/end-stake-costs](https://dune.com/hexpay_day/end-stake-costs)
...
2.  wait multiple days to end a stake since hex has 14 days before penalty is accrued from late ends during periods of high base fee
...
This file was generated by Swimm. [Click here to view it in the app](https://app.swimm.io/repos/Z2l0aHViJTNBJTNBc3Rha2UtbWFuYWdlciUzQSUzQWhleHBheS1kYXk=/docs/ck10cmn2).
